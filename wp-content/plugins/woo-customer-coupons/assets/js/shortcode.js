jQuery(document).ready(function ($) {
    ...
    $('.vi_wcc_woo_custumer_coupon-wrap').unbind().click(function () {
        if ($(this).find('.vi_wcc_coupon_terms').length) {
            return false;
        }
        $(this).find('button[name="vi_wcc_woo_customer_coupon_button_click"]').click();
    });
    $('button[name="vi_wcc_woo_customer_coupon_button_click"]').click(function (e) {
        if ($(this).closest('.vi_wcc_woo_custumer_coupon-wrap').find('.vi_wcc_coupon_terms').length) {
            return false;
        }
        if (!coupon_wcc_ajax.is_cart || coupon_wcc_ajax.is_cart === '') {
